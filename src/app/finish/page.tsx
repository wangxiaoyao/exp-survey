    ...
    <div className="container mx-auto max-w-4xl px-4 py-8">
      <div className="rounded-lg p-8 shadow-md">
        ...
        <div className="space-y-6">
          ...
          <p>
            我们邀请您参与本研究，是希望了解人工智能在人机互动中的安慰剂效应。我们邀请您参加这项研究，是因为您已年满18岁，能说中文，且为大学生。
          </p>
          ...
          <p>
            感谢您的参与。没有像您这样的参与者的善意和合作，我们无法进行这项研究。我们非常感激您的贡献。
          </p>
          ...
          <p>
            我们开展此项研究是为了探讨当人们在系统互动中接触到不同的适应性描述时，安慰剂效应如何发挥作用。在本实验中，参与者会被随机分配到两个组别中的一个：无适应性组或基于错误的适应性组。为了确保实验分配操作的有效性，在两组参与者完成同一组字谜任务之前，我们将提供不同的系统描述。之后，他们将首先回答期望问题，再完成一系列字谜任务，并在最后填写期望问卷。尽管给予的系统描述不同，但实际上两组的字谜任务条目、顺序和难度是完全相同的，并且都没有人工智能在调节任务难度。通过此类研究，我们可能在未来能够理解不同适应系统的安慰剂效应。
          </p>
          ...
          <p>
            为了方便研究，请不要与任何未来可能参与本研究的人讨论您今天的参与情况。所有参与者必须保持&quot;无知&quot;状态，避免了解实验的目的，以确保我们研究结果的有效性——即使参与者尽力在实验中诚实回答，了解过多实验信息也会在微妙和无意识的层面上影响他们的行为。
          </p>
        </div>
      </div>
    </div>
